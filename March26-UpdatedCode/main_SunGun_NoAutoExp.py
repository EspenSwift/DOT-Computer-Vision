...
import time
from EllipseFittingFunctions_NoAutoExp import *
...
try:    
    while True:
        ...
        ellipse, prev_max_area,  prev_circle, used_prev_circle = EllipseFromFrame(frame_bgr, prev_max_area, prev_circle, used_prev_circle)
