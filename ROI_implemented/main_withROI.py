...
if zed.grab(runtime) == sl.ERROR_CODE.SUCCESS:
    ...
    roi_tracker = ROITracker(frame_w=w, frame_h=h,
                         lock_hits=2,      # lock after 2 good frames
                         max_misses=3,     # reset after 3 misses
                         scale=2.5,        # ROI size = 2.5 * ellipse max axis
                         min_size=180,
                         max_size=900,
                         expand_on_miss=1.25)
